export const navItems = [
  ...
  export const gridItems = [
    ...
    },
    {
      ...
      className: "lg:col-span-2 md:col-span-3 md:row-span-2 row-span-3",
      imgClassName: "",
  ...
  export const projects = [
    {
      id: 1,
      title: "LYRA - Powered by Gemini",
      des: "Reimagining of Gemini platform, focused on delivering similar functionality with improved design",
      img: "/lyra-poster.png",
      iconLists: ["/re.svg", "/js.png", "/vite.png", "/gemini.png"],
